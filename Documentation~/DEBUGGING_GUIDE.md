...
// Watch Unity Console for [EngineIO], [SocketIO], [Binary] logs
```
...
```
[EngineIO] Handshake received (sid=abc123, pingInterval=25000ms, pingTimeout=20000ms)
[SocketIO] → CONNECT /
[SocketIO] ← CONNECT / {"sid":"xyz789"}
[SocketIO] → EVENT ["chat","hello"]
[SocketIO] ← EVENT ["chat","world"]
[Binary] ← BINARY 256 bytes
...
**Symptoms:**
```
[Transport] Transport error: Connection refused
```
...
**Symptoms:**
```
[EngineIO] Engine.IO heartbeat timeout
```
...
**Symptoms:**
```
[Namespace] /admin connect_error: unauthorized
```
